...
class FormularioApp:
    ...
    def create_form(self):
        ...
        try:
            # Inserta el formulario y recupera el id generado
            self.cursor.execute(
                "INSERT INTO Formulario (descrip_formulario, fecha_creacion, Id_est_formulario) VALUES (%s, CURRENT_DATE, %s) RETURNING Id_formulario",
                (desc, 1)
            )
            ...
            for question in questions:
                ...
                if question_id:
                    self.cursor.execute("INSERT INTO FormularioxPregunta (Id_formulario, Id_pregunta) VALUES (%s, %s)", (form_id, question_id[0]))
                else:
                    raise Exception("Error al insertar la pregunta")
