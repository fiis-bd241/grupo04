...
class ProdIn(Toplevel):
    ...
    def contruirWidget(self):         
        self.labelVersion = Label(self,text="Producto Ingresado Correctamente")
        self.labelVersion.config(fg="#000000",font=("Roboto",15),pady=1,width=60)
        self.labelVersion.pack()
