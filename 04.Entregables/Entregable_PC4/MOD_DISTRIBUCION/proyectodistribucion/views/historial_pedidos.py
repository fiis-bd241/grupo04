...
from controllers.pedido_controller import obtener_historial_pedidos

class HistorialPedidosView(tk.Frame):
    ...
    def create_widgets(self):
        self.label = tk.Label(self, text="Historial de Pedidos")
        ...
        pedidos = obtener_historial_pedidos()
