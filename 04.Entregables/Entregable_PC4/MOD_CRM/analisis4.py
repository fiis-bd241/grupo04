...
class Application:
    def __init__(self, master):
        ...
        self.figures = []  # Almacenar todas las figuras
        ...
        self.plot_button = ttk.Button(self.frame, text="Graficar", command=self.on_plot_button_click)
    ...
    def plot_data(self, data, chart_type, x_col, y_col):
        fig, ax = plt.subplots(figsize=(10, 6))  # Tamaño del gráfico aumentado
