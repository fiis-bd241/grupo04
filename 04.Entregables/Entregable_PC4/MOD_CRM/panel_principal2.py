...
class MainPanelApp:
    ...
    def create_main_content(self):
        ...
        btn_potenciales = tk.Button(mejor_valor_frame, text="Mis Clientes Potenciales", font=('Arial', 14), bg='#F5C6CB', fg='black')
    ...
    def run_enviar_wats(self):
        os.system('python c:/Users/Administrador/Desktop/pythonproyects/apli_escri/enviar_wats4.py')
    ...
    def run_crear_formularios(self):
        os.system('python c:/Users/Administrador/Desktop/pythonproyects/apli_escri/crear_formularios12.py')

    def run_correos_enviar(self):
        os.system('python c:/Users/Administrador/Desktop/pythonproyects/apli_escri/correos_enviar7.py')
